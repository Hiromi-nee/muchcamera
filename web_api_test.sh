...
curl -XGET "http://127.0.0.1:5002/recommend_settings_wo_image?style=SM&image_id=0&ff_fl=35&orig_fl=23&model=x100s&sensor_size=APSC&max_aperture=16&min_aperture=2&max_shutter_speed=30&min_shutter_speed=1%2F4000&max_iso=6400&min_iso=100&max_fl=35&min_fl=35&multiplier=1.5"
